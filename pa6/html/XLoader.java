...
//            cfg.load(CaptionLoader.class.getClassLoader().getResourceAsStream("db.cfg"));
   ...
   public static void main(String argv[]) {
    ...
    try {
        ...
        String id, title, body, category, from, to, summary, url;
          ...
          try{
		        ...
		        if (qName.equalsIgnoreCase("eecs485_article")) {
			        String queryString1 = "INSERT IGNORE Article (id, title, body) VALUES " +
                            "('" + id + "','" + title + "','" + body + "');"; 
              ...
              body = null;
		        ...
		        if (qName.equalsIgnoreCase("eecs485_category")) {
			        String queryString1 = "INSERT IGNORE Category (id, title, category) VALUES " +
                            "('" + id + "','" + title + "','" + category + "')"; 
              ...
              category = null;
		        ...
		        if (qName.equalsIgnoreCase("eecs485_edge")) {
			        String queryString1 = "INSERT IGNORE Edge (id_from, id_to) VALUES " +
                            "('" + from + "','" + to + "')"; 
            ...
            if (qName.equalsIgnoreCase("eecs485_summary")) {
			        String queryString1 = "INSERT IGNORE Summary (id, title, summary) VALUES " +
                            "('" + id + "','" + title + "','" + summary + "')"; 
      ...
      saxParser.parse("mining.articles.xml", handler);
      saxParser.parse("mining.category.xml", handler);
      saxParser.parse("mining.edges.xml", handler);
      saxParser.parse("mining.imageUrls.xml", handler);
      saxParser.parse("mining.infobox.xml", handler);
    } catch (Exception e) {
       e.printStackTrace();
       System.exit(1);
    }
